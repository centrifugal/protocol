...
type ConnectResult struct {
	...
	Session string                      `protobuf:"bytes,9,opt,name=session,proto3" json:"session,omitempty"`
	Node    string                      `protobuf:"bytes,10,opt,name=node,proto3" json:"node,omitempty"`
	TimeMs  int64                       `protobuf:"varint,11,opt,name=time_ms,json=timeMs,proto3" json:"time_ms,omitempty"` // Server time as Unix timestamp in milliseconds (not sent by default).
}
...
func (x *ConnectResult) GetTimeMs() int64 {
	if x != nil {
		return x.TimeMs
	}
	return 0
...
var file_client_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x74, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x1a,
