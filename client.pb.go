...
type HistoryRequest struct {
	Channel   string `protobuf:"bytes,1,opt,name=channel,proto3" json:"channel"`
	WithSince bool   `protobuf:"varint,2,opt,name=with_since,json=withSince,proto3" json:"with_since,omitempty"`
	Offset    uint64 `protobuf:"varint,3,opt,name=offset,proto3" json:"offset,omitempty"`
	Epoch     string `protobuf:"bytes,4,opt,name=epoch,proto3" json:"epoch,omitempty"`
	WithLimit bool   `protobuf:"varint,5,opt,name=with_limit,json=withLimit,proto3" json:"with_limit,omitempty"`
...
func (m *HistoryRequest) GetWithSince() bool {
	if m != nil {
		return m.WithSince
	}
	return false
...
func (m *HistoryRequest) GetWithLimit() bool {
	if m != nil {
		return m.WithLimit
	}
	return false
...
func (this *HistoryRequest) Equal(that interface{}) bool {
	...
	if this.WithSince != that1.WithSince {
		return false
	}
	if this.Offset != that1.Offset {
		return false
	...
	if this.WithLimit != that1.WithLimit {
		return false
	}
...
func NewPopulatedHistoryRequest(r randyClient, easy bool) *HistoryRequest {
	this := &HistoryRequest{}
	this.Channel = string(randStringClient(r))
	this.WithSince = bool(bool(r.Intn(2) == 0))
	this.Offset = uint64(uint64(r.Uint32()))
	this.Epoch = string(randStringClient(r))
	this.WithLimit = bool(bool(r.Intn(2) == 0))
...
func (m *HistoryRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithSince", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithLimit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorClient = []byte{
	...
	,
}
