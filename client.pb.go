...
type ConnectRequest struct {
	...
	Subs  []*SubscribeRequest `protobuf:"bytes,3,rep,name=subs" json:"subs,omitempty"`
}
...
func (m *ConnectRequest) GetSubs() []*SubscribeRequest {
	if m != nil {
		return m.Subs
	}
	return nil
...
func NewPopulatedConnectRequest(r randyClient, easy bool) *ConnectRequest {
	...
	if r.Intn(10) != 0 {
		v11 := r.Intn(5)
		this.Subs = make([]*SubscribeRequest, v11)
		for i := 0; i < v11; i++ {
			this.Subs[i] = NewPopulatedSubscribeRequest(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func (m *ConnectRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Subs = append(m.Subs, &SubscribeRequest{})
...
var fileDescriptorClient = []byte{
	...
	,
}
