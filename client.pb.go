...
type HistoryRequest struct {
	Channel    string `protobuf:"bytes,1,opt,name=channel,proto3" json:"channel"`
	WithFilter bool   `protobuf:"varint,2,opt,name=with_filter,json=withFilter,proto3" json:"with_filter,omitempty"`
...
func (m *HistoryRequest) GetWithFilter() bool {
	if m != nil {
		return m.WithFilter
	}
	return false
...
func (this *HistoryRequest) Equal(that interface{}) bool {
	...
	if this.WithFilter != that1.WithFilter {
		return false
	}
	if this.Offset != that1.Offset {
		return false
...
func NewPopulatedHistoryRequest(r randyClient, easy bool) *HistoryRequest {
	this := &HistoryRequest{}
	this.Channel = string(randStringClient(r))
	this.WithFilter = bool(bool(r.Intn(2) == 0))
	this.Offset = uint64(uint64(r.Uint32()))
	this.Epoch = string(randStringClient(r))
...
func (m *HistoryRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithFilter", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorClient = []byte{
	...
	,
}
