...
func (m *Dictionary) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.DataB64) > 0 {
		i -= len(m.DataB64)
		copy(dAtA[i:], m.DataB64)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DataB64)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Data) > 0 {
...
func (m *Publication) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PrevData) > 0 {
		i -= len(m.PrevData)
		copy(dAtA[i:], m.PrevData)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PrevData)))
		i--
		dAtA[i] = 0x7a
	}
	if len(m.Epoch) > 0 {
	...
	if m.Score != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64((uint64(m.Score)<<1)^uint64((m.Score>>63))))
		i--
		dAtA[i] = 0x68
	}
	if m.Removed {
...
func (m *KeyedItem) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *KeyedItem) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *KeyedItem) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *TrackBatch) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *TrackBatch) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *TrackBatch) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *SubRefreshRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Untrack) > 0 {
		for iNdEx := len(m.Untrack) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Untrack[iNdEx])
			copy(dAtA[i:], m.Untrack[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Untrack[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.Track) > 0 {
		for iNdEx := len(m.Track) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.Track[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Publication) SizeVT() (n int) {
	...
	if m.Score != 0 {
		n += 1 + protohelpers.SizeOfZigzag(uint64(m.Score))
	}
	l = len(m.Epoch)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
...
func (m *SubscribeRequest) SizeVT() (n int) {
	...
	if m.Phase != 0 {
		n += 2 + protohelpers.SizeOfVarint(uint64(m.Phase))
	}
	l = len(m.Cursor)
	if l > 0 {
...
func (m *Dictionary) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DataB64", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Publication) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevData", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrevData = append(m.PrevData[:0], dAtA[iNdEx:postIndex]...)
			if m.PrevData == nil {
				m.PrevData = []byte{}
			}
			iNdEx = postIndex
...
func (m *SubscribeResult) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			...
			m.State = append(m.State, &Publication{})
...
func (m *KeyedItem) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyedItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyedItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TrackBatch) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TrackBatch: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TrackBatch: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Items = append(m.Items, &KeyedItem{})
...
func (m *SubRefreshRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Track = append(m.Track, &TrackBatch{})
			if err := m.Track[len(m.Track)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Untrack", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Untrack = append(m.Untrack, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *SubRefreshResult) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Items = append(m.Items, &Publication{})
			if err := m.Items[len(m.Items)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
